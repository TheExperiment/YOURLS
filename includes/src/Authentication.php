...
class Authentication {
     ...
     */
    function phpass_instance( $iteration = 8, $portable = false ) {
     ...
     */
    function has_cleartext_passwords() {
        global $user_passwords;
     ...
     *
     */
    function check_signature_timestamp() {
     ...
     *
     */
    function auth_signature( $username = false ) {
     ...
     *
     */
    function store_cookie( $user = null ) {
        if( !$user ) {
            $pass = null;
            $time = time() - 3600;
        } else {
